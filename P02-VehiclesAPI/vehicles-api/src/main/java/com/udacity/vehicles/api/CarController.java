...
class CarController {
    ...
    ResponseEntity<?> post(@Valid @RequestBody Car car) throws URISyntaxException {
        ...
        // using assembler to return the saved car as part of the response
        Resource<Car> resource = assembler.toResource(savedCar);

        // Return a response with a 201 Created status and the location of the newly created resource
    ...
    ResponseEntity<?> put(@PathVariable Long id, @Valid @RequestBody Car car) {
        ...
        // Setting id of input car object
        car.setId(id);

        //Saving the car with save method
        Car updatedCar = carService.save(car);

        //Assembler to make it part of the response
    ...
    ResponseEntity<?> delete(@PathVariable Long id) {
        ...
        //Car service to delete car with id
